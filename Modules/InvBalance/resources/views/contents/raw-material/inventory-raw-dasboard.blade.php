...
@section('content')
  <div class="card card-action my-4">
    <div class="card-header pb-1">
      <h5 class="card-action-title mb-0">Inventory Raw Material</h5>
    ...
    <div class="card-body py-3" id="tab-content-block">
      @include('invbalance::contents.raw-material.excels.inventory-raw-excel')
    </div>
  </div>
  @include('invbalance::contents.raw-material.modals.inventory-filter-offcanvas')
