...
<head>
  ...
  <!-- Favicon -->
  <link rel="icon" type="image/x-icon" href="{{ asset('images/Logo-EOB-only.ico') }}" />
  ...
  @include('layouts/sections/scripts-includes' . $isFront)
</head>
...
<body>
  ...
  {{-- This is where all pushed scripts will be placed --}}
  @stack('js')
