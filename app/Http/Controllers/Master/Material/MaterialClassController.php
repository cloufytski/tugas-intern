...
use App\Http\Resources\Master\Material\MaterialClassResource;
use App\Repositories\Implementations\Master\Material\MaterialClassRepository;
...
class MaterialClassController extends Controller
{
    public function __construct(
        protected MaterialClassRepository $repository,
    ) {}

    public function index(Request $request)
    {
        if ($request->has('class')) {
            $data = $this->repository->searchByClass($request->get('class') ?? '');
            ...
            return (new AnonymousResourceCollection(
                ...
                MaterialClassResource::class
            ))->response();
        }
        return response()->json([
            'success' => true,
            'data' => MaterialClassResource::collection($data),
        ]);
    }
    ...
    public function store(Request $request)
    {
        ...
        return response()->json([
            'success' => true,
            'message' => 'Material Class ' . $data->class . ' is successfully added.',
            'data' => MaterialClassResource::make($data),
    ...
    public function update(Request $request, string $id)
    {
        ...
        if ($request->has('is_restore')) {
            ...
            return response()->json([
                'success' => true,
                'message' => 'Material Class ' . $data->class . ' is successfully restored.',
                'data' => MaterialClassResource::make($data),
            ]);
        } else {
            $validate = $request->validate([
            ...
            return response()->json([
                'success' => true,
                'message' => 'Material Class ' . $data->class . ' is successfully updated.',
                'data' => MaterialClassResource::make($data),
            ]);
        }
    }
    ...
    public function destroy(string $id)
    {
        ...
        return response()->json([
            'success' => true,
            'message' => 'Material Class ' . $data->class . ' is successfully deleted.',
        ]);
    }
}
